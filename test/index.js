...
const table = {
    ...
    'ellipsis3': '.foo { overflow: hidden; text-overflow: ellipsis; display: -webkit-box; -webkit-box-orient: vertical; -webkit-line-clamp: 3; line-height: 1.25em; max-height: 3.75em; box-sizing: content-box; word-break: break-all; overflow-wrap: break-word; }',
    ...
    'flex-row-ct': '.foo { display: flex; flex-direction: row; align-items: flex-start; align-content: flex-start; justify-content: center; }',
    'flex-row-cb': '.foo { display: flex; flex-direction: row; align-items: flex-end; align-content: flex-end; justify-content: center; }',
    'flex-row-tl': '.foo { display: flex; flex-direction: row; align-items: flex-start; align-content: flex-start; justify-content: flex-start; }',
    ...
    'flex-col-ct': '.foo { display: flex; flex-direction: column; align-items: center; align-content: center; justify-content: flex-start; }',
    'flex-col-cb': '.foo { display: flex; flex-direction: column; align-items: center; align-content: center; justify-content: flex-end; }',
    'flex-col-tl': '.foo { display: flex; flex-direction: column; align-items: flex-start; align-content: flex-start; justify-content: flex-start; }',
    ...
    'flex-self-start': '.foo { align-self: flex-start; }',
    'flex-self-end': '.foo { align-self: flex-end; }',
    'flex-self-center': '.foo { align-self: center; }',
    'flex-self-baseline': '.foo { align-self: baseline; }',
    'flex-self-stretch': '.foo { align-self: stretch; }',
