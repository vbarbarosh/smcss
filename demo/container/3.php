...
<div id="app" class="mt50">
    ...
    <div class="ma dashed bs10 red" v-bind:style="{width: width + 'px'}">
        <ul class="xls xp xm flex-row-fluid flex-wrap mt10n ml10n">
            <li v-for="clipart in cliparts" class="w100 mt10 ml10 expand-1-1 br3 theme-white">
            ...
            <!-- padding -->
            <li v-for="n in 10" class="w100 ml10"></li>
        </ul>
    </div>
</div>
